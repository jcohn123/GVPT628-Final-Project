...
- `Data` — CSV and ZIP data files _(For descriptive table on Democratic and Republican Advertisers, feel free to download the datasets as a CSV file)_
